...
namespace SharedKernel
{
    public static class LinqHelper
    {
        ...
        /// <summary>
        /// Gets a unique key for an expression to perform caching.
        /// </summary>
        //from article: https://petemontgomery.wordpress.com/2008/08/07/caching-the-results-of-linq-queries/
    ...
    internal class LocalCollectionExpander : ExpressionVisitor
    {
        public static Expression Rewrite(Expression expression) =>
            new LocalCollectionExpander().Visit(expression);
